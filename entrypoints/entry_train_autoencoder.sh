...
DEFAULT_EXP_NAME="combustion-ae-v0"
EXP_NAME="${EXP_NAME:-${DEFAULT_EXP_NAME}}"
CONFIG_PATH="${CONFIG_PATH:-configs/autoencoder_base.yaml}"
RESULTS_DIR="${RESULTS_DIR:-results/autoencoder}"
PRECISION="${PRECISION:-bf16}"
RESUME="${RESUME:-false}"
CKPT_PATH="${CKPT_PATH:-}"
LOG_ROOT="${LOG_ROOT:-logs/autoencoder}"
...
echo "--- Combustion AE Cluster Launch ---"
